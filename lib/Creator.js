 ...
 * @Description:
 * @FilePath: /iov-cli/lib/Creator.js
 */
...
module.exports = class Creator extends EventEmitter {
  constructor(name, context) {
    super();
    this.name = name;
    this.context = process.env.IOV_CLI_CONTEXT = context; // 项目绝对路径
  }

  async create(cliOptions = {}) {
    const { name, context } = this;
    const templateGitRepoJson = readTemplateJson();
    const gitRepoUrl = templateGitRepoJson[process.env.IOV_CLI_TEMPLATE_NAME];
    let tmpdir;
